...
const Footer = () => {
    return (
        ...
        <footer className="footer footer-center p-10 bg-primary text-primary-content bg-gradient-to-r from-primary to-secondary rounded-t-xl">
  <div>
    <img src={nanicon} style={{height:'100px'}} alt=''></img>
    <p className="font-bold">
      ACME Industries Ltd. <br/>Providing reliable tech since 2020
    </p> 
